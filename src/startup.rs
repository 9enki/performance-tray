...
mod run_key {
    ...
    const VALUE_NAME: &str = "PerformanceTray";
...
mod startup_task {
    ...
    const TASK_ID: &str = "PerformanceTrayStartup";
...
mod tests {
    ...
    fn コマンドラインを引用符で囲む() {
        assert_eq!(
            command_line(r"C:\Program Files\PerformanceTray.exe", "--show cpu"),
            r#""C:\Program Files\PerformanceTray.exe" --show cpu"#
        );
        assert_eq!(command_line(r"C:\a\b.exe", ""), r#""C:\a\b.exe""#);
        assert_eq!(command_line(r"C:\a\b.exe", "--show memory"), r#""C:\a\b.exe" --show memory"#);
    }
